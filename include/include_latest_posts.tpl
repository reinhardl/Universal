	        ...
	        <div class="container">
	        	<div class="row">
	        		...
	        		<div class="col-sm-6 featured-news">
	        			...
	        			<div class="row">
	        				<div class="col-xs-4"><a href="blog-post.html"><img src="/templates/Basica/img/blog/1.jpg" alt="Post Title"></a></div>
	        				<div class="col-xs-8">
	        			...
	        			<div class="row">
	        				<div class="col-xs-4"><a href="blog-post.html"><img src="/templates/Basica/img/blog/2.jpg" alt="Post Title"></a></div>
	        				<div class="col-xs-8">
	        			...
	        			<div class="row">
	        				<div class="col-xs-4"><a href="blog-post.html"><img src="/templates/Basica/img/blog/3.jpg" alt="Post Title"></a></div>
	        				<div class="col-xs-8">
